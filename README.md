...
面向中文视觉小说 / Galgame 写作的简易AI本地提示词工作台。

角色记忆、场景卡、路线图、CSV 剧本、可读稿、引擎导出、Excel 交付表和质量检查工具等放在一套流程里。AI 或协作者拿到仓库后，可以沿着文件结构理解项目、继续写作、检查交付。写作内容质量仅供参考。
